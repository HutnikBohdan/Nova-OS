...
const PREEMPT_USER_IMAGE: &[u8] = &[
    0x66, 0x48, 0x0f, 0x6e, 0xc3, // movq xmm0, rbx (initialize once)
    0x66, 0x48, 0x0f, 0x7e, 0xc0, // loop: movq rax, xmm0
    0x48, 0x39, 0xd8, // cmp rax, rbx
    0x75, 0x0f, // jne failure
    0x48, 0xb8, 0x00, 0x00, 0x60, 0x00, 0x00, 0x00, 0x00, 0x00, // mov rax, 0x600000
    0x48, 0xff, 0x00, // inc qword [rax]
    0xeb, 0xe7, // jmp loop
    0x48, 0xb8, 0x08, 0x00, 0x60, 0x00, 0x00, 0x00, 0x00, 0x00, // failure address
    0x48, 0xc7, 0x00, 0x01, 0x00, 0x00, 0x00, // mov qword [rax], 1
    0xeb, 0xfe, // failure: spin
    0x48, 0xb8, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // mov rax, 1
    0x48, 0xbf, 0x4b, 0x4f, 0x33, 0x52, 0x41, 0x56, 0x4f, 0x4e, // mov rdi, marker
    0x48, 0x31, 0xf6, // xor rsi, rsi
    0xcd, 0x80, // int 0x80
...
pub const PREEMPT_EXIT_IP: u64 = USER_CODE_BASE + 49;
